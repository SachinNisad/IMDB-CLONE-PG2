// Search API Link: http://www.omdbapi.com/?s=spiderman&apikey=e064562b
// Details API Link: http://www.omdbapi.com/?i=tt3896198&apikey=e064562b
...
async function loadMovies(searchTerm){
    await fetch(`https://omdbapi.com/?s=${searchTerm}&page=1&apikey=e064562b`)
...
function displayMovieList(movies){
    ...
    for(let idx = 0; idx < movies.length; idx++){
        ...
        fetch(`http://www.omdbapi.com/?i=${movies[idx].imdbID}&apikey=e064562b`)
        .then((response) => response.json())
        .then((data) => {
...
function loadMovieDetails(){
    ...
    searchListMovies.forEach(movie => {
        movie.addEventListener('click', () => {
            fetch(`http://www.omdbapi.com/?i=${movie.dataset.id}&apikey=e064562b`)
            .then((response) => response.json())
            .then((data) => {
